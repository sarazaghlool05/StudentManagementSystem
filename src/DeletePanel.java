...
public class DeletePanel extends JPanel {
    ...
    public DeletePanel(StudentManager manager, CardLayout cardLayout, JPanel mainPanel) {
        ...
        // Button setup
        deleteButton = MainFrame.createStyledButton(
        ...
        // Ensure table refreshes whenever this panel becomes visible
    ...
    private void initializeTable() {
        ...
        // Styling to match ViewStudentsPanel
    ...
    private void handleDeleteAction() {
        ...
        // convert view row to model row (safer when sorting/filtering applied)
